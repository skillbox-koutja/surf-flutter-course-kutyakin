...
final _minDistance = Environment.instance.buildConfig.minDistance;
final _maxDistance = Environment.instance.buildConfig.maxDistance;
final _radius = Environment.instance.buildConfig.radius;
final _initialLocation = Environment.instance.buildConfig.initialLocation;
final RangeValues _distanceLimit = RangeValues(_minDistance, _maxDistance);
final _remoteDataSource = PlaceRemoteDataSource(
  buildDioClient(Environment.instance.buildConfig.placesApiUrl),
);
